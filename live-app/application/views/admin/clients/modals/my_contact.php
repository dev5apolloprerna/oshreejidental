...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php $customer_id = isset($customer_id) ? $customer_id : ''; echo form_open(admin_url('clients/form_contact/' . $customer_id . (isset($contactid) ? '/' . $contactid : '')), ['id' => 'contact-form', 'autocomplete' => 'off']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php $contactid = isset($contactid) ? $contactid : '';?>
                      ...
                      <!--   <p class="bold"><?php echo _l('customer_permissions'); ?></p>
                        ...
                        ?>
                        <?php if (isset($customer_permissions)) {
