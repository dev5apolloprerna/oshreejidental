...
class Invoices extends AdminController
{
    ...
    public function invoice($id = '')
    {
        if ($this->input->post()) {
            ...
            if (isset($invoice_data['date']) && $invoice_data['date'] !== '') {
                $invoice_data['date'] = to_sql_date($invoice_data['date']);
            }
            if (isset($invoice_data['duedate'])) {
                $invoice_data['duedate'] = $invoice_data['duedate'] !== '' ? to_sql_date($invoice_data['duedate']) : null;
            }
