                            ...
                            <div class="row">
                                <div class="col-md-3">
                                  <div class="select-placeholder">
                                    ...
                                    <option value="leads"  <?php echo  $_GET['repo_type'] == 'leads' ? 'selected' : ''?>>Leads</option>
                              ...
                              <div class="col-md-3">
                                  <div class="select-placeholder">
                                    ...
                                    foreach($statuses as $status){
                                      ...
                                      $selected_cus = ($status['id'] == $_GET['status']) ? 'selected' : '';
                                      echo '<option value="'.$status['id'].'" '.$selected_cus.'>'.$status['name']. '</option>';
                                    }
                                    ?>
                                   </select>
                                </div>
