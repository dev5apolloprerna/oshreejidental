                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" id="div_dob">
                            <label for="dob"><?= _l('DOB'); ?></label>
                            <input type="date" <?= isset($history['details']) || $history['source'] == 'lead_related' ? 'disabled' : ''; ?>
                                   value="<?php if (isset($history['dob'])) echo $history['dob']; else if (isset($history['details']['dob'])) echo $history['details']['dob']; ?>"
                        ...
                        <input type="text" class="form-control" name="subject" id="subject"
                               value="<?= $history['subject']; ?>" readonly>
                    ...
                    <div class="col-md-6">
                         <div class="form-group mtop20">
                            ...
                            <textarea name="description" class="form-control" id="description"
                                      rows="2"><?= $history['description']; ?></textarea>
                        </div>


                        <div class="form-group mtop20">
                            <label for="pt_address"><?= _l('Address'); ?></label>
                            <textarea name="pt_address" class="form-control" id="pt_address"
                                      rows="2"><?= $history['pt_address']; ?></textarea>
                        </div>
                        ...
                        <div class=" available_times_labels_edit appointment_hours" style="width:100%;margin-bottom: 15px;">
