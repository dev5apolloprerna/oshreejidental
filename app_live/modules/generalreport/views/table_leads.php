...
$aColumns = array_merge($aColumns, [
        ...
        if($this->ci->input->get('staff_id') != ''){
            $filters[] = 'AND (assigned =' . $this->ci->input->get('staff_id') . ' OR addedfrom = ' . $this->ci->input->get('staff_id') . ')';
        }
        ...
        if($filter == 'today')
        {
             $filters[] = 'AND dateadded BETWEEN "'.$beginOfDay.'" AND "'.$endOfDay.'"';
           

        }
        elseif($filter == 'this_week')
        {
            $filters[] = 'AND dateadded BETWEEN "'.$beginThisWeek.'" AND "'.$endThisWeek.'"';
           
        }
        elseif($filter == 'this_month')
        {
            $filters[]= 'AND dateadded BETWEEN "'.$beginThisMonth.'" AND "'.$endThisMonth.'"';
        ...
        if($start_date != '' && $end_date != ''){
            ...
            if($filter == ''){
                 $filters[] = 'AND dateadded BETWEEN "'.$start_date.'" AND "'.$end_date.'"';
            }
