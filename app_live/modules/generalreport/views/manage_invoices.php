                                ...
                                <div class="col-md-3">
                                  <div class="select-placeholder">
                                   ...
                                   <select name="repo_type" id="repo_type" class="selectpicker" data-width="100%" data-live-search="true">
                                    ...
                                    <option value="payment_receipts" <?php echo  $_GET['repo_type'] == 'payment_receipts' ? 'selected' : ''?>>Payment Receipts</option>
                                    <option value="doctor_treatment" <?php echo  $_GET['repo_type'] == 'doctor_treatment' ? 'selected' : ''?>>Doctor Treatment Report</option>                                                                      
                                   </select>
                                </div>
                               </div>
                              <div class="col-md-3">
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                  <div class="select-placeholder">
                                    <label><?php echo _l('Filter By Status'); ?>
                                   ...
                                   <select name="status" id="status" class="selectpicker" data-width="100%" data-live-search="true">
                                    <option value=""></option>
                                    <?php
                                    foreach($invoices_statuses as $invoices_status){

                                      $selected_cus = ($invoices_status == $_GET['status']) ? 'selected' : '';
                                      echo '<option value="'.$invoices_status.'" '.$selected_cus.'>'.format_invoice_status($invoices_status) .'</option>';
                                    }
                                    ?>
                                   </select>
                                </div>
...
foreach($custom_fields as $field){
  array_push($table_data, [
   ...
   'th_attrs' => array('data-type'=>$field['type'], 'data-custom-field'=>1)
                    ...
                    //     array(
                    //         'name' => _l('#'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-customer-name')
                    //     ),
                    //     array(
                    //         'name' => _l('Customer'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-comp')
                    //     ),
                    //      array(
                    //         'name' => _l('Subject'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-comp')
                    ...
                    //      array(
                    //         'name' => _l('Message'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-remark')
                    //     ),
                    //     array(
                    //         'name' => _l('Staff'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-assi_mech')
                    //     ),
                    //     array(
                    //         'name' => _l('Status'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-sce')
                    //     ),
                    //     array(
                    //         'name' => _l('Created Date'),
                    //         'th_attrs' => array('class' => '', 'id' => 'th-type')
                    //     ),
