    ...
    {             
        ...
        if (isset($data['firstname']) && isset($data['lastname']) && $data['firstname'] != '' && $data['lastname'] != '') {
            ...
            $contact_data = [
                ...
                'email' => $data['email'],
                'phonenumber' => $data['phonenumber'],
                'rx_str_date' => $data['rx_str_date'],
                'rx_end_date' => $data['rx_end_date'],
            ...
            $medical_history = [
                ...
                'tobaco_past' => $data['tobaco_past'],
                'tobaco_present' => $data['tobaco_present'],
                'alcohol_past' => $data['alcohol_past'],
                'alcohol_present' => $data['alcohol_present'],
                'marital_status' => $data['marital_status'],
                'surgical_history' => $data['surgical_history'],
                'enviro_factors' => $data['enviro_factors'],
                ...
                'previous_medication' => $data['previous_medication'],
            ];
