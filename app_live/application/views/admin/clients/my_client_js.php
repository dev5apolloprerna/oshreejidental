...
$(function() {
    appValidateForm($('#client-attachments-upload'), {
        xray_title: 'required',
        file: 'required',      
    });
});
...
function showHideTextareas() {
    if ($('#immediate_cb').is(':checked')) {
        $('#immediate_textarea').show();
    } else {
        $('#immediate_textarea').hide();
    }

    if ($('#planned_cb').is(':checked')) {
        $('#planned_textarea').show();
    } else {
        $('#planned_textarea').hide();
    }
}
