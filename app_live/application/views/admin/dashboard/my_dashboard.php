...
<script>
    $('#date_range').change(function(){
     ...
     if(val == 'today'){
        ...
        document.getElementById('from_date').value = "<?php echo date('Y-m-d', strtotime('monday this week'));?>";
        document.getElementById('to_date').value = "<?php echo date('Y-m-d', strtotime('sunday this week'))?>";
