...
$path = ACOFFER_DOC_FOLDER;// get dynamic url for images
...
foreach ($rResult as $aRow) {
    ...
    {
        $image = '<img id="zoom_01" src="'.$path.$aRow['branchid'].'/IMG_'.$aRow['image'].'" width="100px" height="100px" >';
    }
    $row[] = $image;
    $planname = $aRow['branch_name'];
