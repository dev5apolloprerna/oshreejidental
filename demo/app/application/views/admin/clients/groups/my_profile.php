                    ...
                    <div class="row patient_reg">
                        <div class="col-lg-6">
                            ...
                            <div class="patient_email">
                                ...
                                echo render_input('email','Email', $value,true);?>
                                <div class="text-danger">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <?php
                                if ($medical_history !== null) {
                                    $treatment_plan = explode(', ', $medical_history->treatment_plan);
                                } else {
                                    $treatment_plan = array(); 
                                }
                            ?>
                            <div class="treatment-plan">
                                <label for="treatment-plan" class="tw-text-neutral-700">Treatment Plan</label><br>
                                ...
                                <input type="checkbox" name="treatment_plan[]" value="Immediate" id="immediate_cb" onchange="showHideTextareas()" <?php if (in_array("Immediate", $treatment_plan)) echo "checked"; ?>>
                                <label>Immediate</label><br>
                                <input type="checkbox" name="treatment_plan[]" value="Planned" id="planned_cb" onchange="showHideTextareas()" <?php if (in_array("Planned", $treatment_plan)) echo "checked"; ?>>
                                <label>Planned</label>
                            </div>
                            <!-- Immediate textarea -->
                            <div id="immediate_textarea" style="display: none;">
                                <?php if (isset($medical_history) && is_object($medical_history)){
                                    $value = $medical_history->immediate_text;
                                }
                                    echo render_textarea('immediate_text', 'Immediate Plan Details', $value, ['id' => 'immediate_text']);
                                ?>
                            </div>
                            <!-- Planned textarea -->
                            <div id="planned_textarea" style="display: none;">
                                <?php if (isset($medical_history) && is_object($medical_history)){
                                    $value = $medical_history->planned_text;
                                }
                                    echo render_textarea('planned_text', 'Planned Plan Details', $value, ['id' => 'planned_text']);
                                ?>
                            </div>
                            <div class="history-comment">
                            <?php if(isset($medical_history) && is_object($medical_history)) {
