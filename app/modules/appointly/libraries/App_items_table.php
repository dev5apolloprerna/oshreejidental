...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $itemHTML .= '<td align="right" width="' . $regularItemWidth . '%">';
            ...
            $itemHTML .= '<td align="right" width="' . $regularItemWidth . '%">' . $item['time_slot'] . '</td>';
            ...
            $itemHTML .= '<td class="amount" align="right" width="' . $regularItemWidth . '%">' . $item['time_slot_timing'] . '</td>';

            $itemHTML .= '<td class="amount" align="right" width="' . $regularItemWidth . '%">' . $item['days'] . '</td>';
    ...
    public function html_headings()
    {
        ...
        $html .= '<th class="description" width="' . $this->get_description_item_width() . '%" align="left">' . 'Medicine' . '</th>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="' . $descriptionItemWidth . '%" align="left">' . 'Medicine' . '</th>';
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . 'Time Slot' . '</th>';

          $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . 'Timing' . '</th>';

        

        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . 'Days' . '</th>';
        $tblhtml .= '</tr>';
