...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12  appointmentWrapper" style="float:none;">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12 mtop15 no-padding">
                                ...
                                <?php if($appointment['contact_id'] != '0'){?>
                                
                                  
                                 <span class="spmodified_fit_center">
                                    <boldit>Case Type :                       </boldit>
                                    <h3 class="appointment_status_info">
                                        <span class="label label-info">Old</span>                                    </h3>
                                </span>
                            ...
                            <?php }else{?>
                                 ...
                                 <span class="spmodified_fit_center">
                                    <boldit>Case Type :                       </boldit>
                                    <h3 class="appointment_status_info">
                                        <span class="label label-info">New</span>                                    </h3>
                                </span>
                            ...
                            <?php }?>
                                ...
                                <span class="spmodified_fit_center">
                                    ...
                                    <h3 class="appointment_status_info">
                                       <a class="label label-info mleft5 approve_appointment_single"  href="<?php echo admin_url('appointly/appointments/convert_customrer/'.$appointment['id']);?>">Convert To Patient</a>                                    </h3>
                                </span>
                            <?php }?>
                            </div>
                                     ...
                                     <!--    <span class="spmodified <?= ($internalStaff) ? 'line-trough-grayish' : '' ?>">
                                        ...
                                        <span class="spmodified client_phone <?= ($internalStaff) ? 'line-trough-grayish' : '' ?>">
                                            ...
                                            <span class="spmodified client_phone ">
                                                ...
                                                <?php
                                                $gender = (isset($appointment['details']['gender'])
                                                    ? ($appointment['details']['gender'])
                                                    : ($appointment['gender']))
                                                    ? $appointment['gender']
                                                    : '';
                                                ?>
                                            ...
                                            <span class="spmodified client_phone ">
                                                ...
                                                <?php
                                                $age = (isset($appointment['details']['age'])
                                                    ? ($appointment['details']['age'])
                                                    : ($appointment['age']))
                                                    ? $appointment['age']
                                                    : '';
                                                ?>
                                            ...
                                            <span class="spmodified client_phone ">
                                                ...
                                                <?php
                                                $dob = (isset($appointment['details']['dob'])
                                                    ? ($appointment['details']['dob'])
                                                    : ($appointment['dob']))
                                                    ? $appointment['dob']
                                                    : '';
                                                ?>
                                            ...
                                            <span class="spmodified client_phone ">
                                                ...
                                                <?php
                                                $pt_address = (isset($appointment['details']['pt_address'])
                                                    ? ($appointment['details']['pt_address'])
                                                    : ($appointment['pt_address']))
                                                    ? $appointment['pt_address']
                                                    : '';
                                                ?>
                                            <?php if ($pt_address !== '') : ?>
