<div class="modal fade" id="newAppointmentModal">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php }?>
                         <div class="form-group" id="select_contacts">
                            ...
                            render_select('contact_id', [], ['contact_id', ['firstname', 'lastname', 'company']], 'appointment_select_single_contact', '', [], [], '', '', true); ?>
                        </div>
                        <div class="form-group " id="div_name">
                            <label for="name"><?= _l('appointment_name'); ?></label>
                            <input type="text" value="" class="form-control" name="name" id="name" readonly>
                        </div>
                        <div class="form-group " id="div_email">
                            <label for="email"><?= _l('appointment_email'); ?></label>
                            <input type="email" value="" class="form-control" name="email" id="email"readonly>
                        </div>
                        <div class="form-group " id="div_phone">
                            <label for="phone"><?= _l('appointment_phone'); ?> (Ex: <?= _l('appointment_your_phone_example'); ?>) </label>
                            <input type="text" value="" class="form-control" name="phone" id="phone" readonly>
                        </div>
                        ...
                        <div class=" available_times_labels appointment_hours" style="width:100%;margin-bottom: 15px;">
                            ...
                            <span class="busy_time_info"  style="
    margin-left: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        ...
                        <div class="form-group">
                            <?php echo render_select('attendees[]', $staff_members, ['staffid', ['firstname', 'lastname']], 'appointment_select_attendees', [get_staff_user_id()], [], [], '', '', false); ?>
                        </div>
