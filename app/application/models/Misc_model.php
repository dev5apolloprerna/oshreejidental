    ...
    public function add_attachment_to_database($rel_id, $rel_type, $attachment, $external = false)
        {                             
            ...
            if ($external == false) {
                ...
                $data['xray_title'] = $attachment[0]['xray_title'];
            } else {
            ...
            if (isset($_POST['xray_upload']) && $_POST['xray_upload'] == 'image') {
               echo json_encode ([
                    'status' => 'success',
                ...
                return;
                 ...
                 set_alert('success','Attachment added successfully');
            }
            // return $insert_id;
            //redirect(admin_url('clients/client/' . $rel_id . '?group=patient_profile'));
            if ($data['rel_type'] == 'customer') {
                return redirect(admin_url('clients/client/' . $rel_id . '?group=patient_profile'));
            } else  {
                return $insert_id;
            }
        }
