    ...
    {          
        ...
        if ($this->input->post() && !$this->input->is_ajax_request()) {       
            if ($id == '') {
                ...
                $this->form_validation->set_rules('phonenumber', 'Phone', 'required|is_unique[tblcontacts.phonenumber]');

                if ($this->form_validation->run() == FALSE)
                {
                        // $this->load->view('admin/clients/groups/my_profile');
                }else{
                    
                
            //     $validationerror = '';
            //     $query = "SELECT phonenumber, email FROM tblcontacts";
            //     $result = $this->db->query($query);
            //     if ($result) {
            //         $phoneNumbers = $result->result_array(); 
                        
            //     foreach ($phoneNumbers as $phoneNumber) {
            //         if ($phoneNumber['phonenumber'] == $data['phonenumber']) {
            //             $validationerror = "Phonenumber already exists";
            //         }
            //     }
            // }
