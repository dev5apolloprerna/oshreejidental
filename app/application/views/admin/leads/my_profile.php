...
<style>
    .lead-wrapper .lead-edit-main-selects .form-group,
    .lead-wrapper .lead-edit-details-row .form-group {
        margin-bottom: 16px;
    }

    .lead-wrapper #inputTagsWrapper {
        margin-bottom: 16px;
    }

    .lead-wrapper #inputTagsWrapper .bootstrap-tagsinput {
        width: 100%;
        min-height: 38px;
        padding: 8px 12px;
    ...
    .lead-wrapper textarea.form-control {
        resize: vertical;
    }

    .lead-wrapper .input-group-addon {
        min-width: 40px;
        text-align: center;
    }
</style>
<div class="<?php if ($openEdit == true) {
    ...
    <div class="row">
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <!-- Top row like reference design: Status, Source, Assigned -->
            ...
            <!-- Tags full width below top row -->
            <div class="row lead-edit-row">
                <div class="col-md-12">
            ...
            <div class="row lead-edit-row lead-edit-details-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" data-toggle="tooltip" title="<?php echo _l('lead_value_tooltip'); ?>">
                            <input type="number" class="form-control" name="lead_value"
                                value="<?php echo(isset($lead) ? e($lead->lead_value) : ''); ?>">
                            <div class="input-group-addon">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <?php
                        ...
                        $selected = (isset($lead) ? $lead->country : '102');
                        echo render_select(
                            'country',
                            $countries,
