            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        render_datatable($table_data, 'branch-wise-patient-search', ['number-index-2'], [
                            'id' => 'branch-wise-patient-search',
                        ]);
                        ?>
                    </div>
                </div>
...
<script>
$(function() {
    var patientSearchTable = initDataTable('.table-branch-wise-patient-search', admin_url + 'clients/branch_wise_patients_table', [0], [0], {}, [7, 'desc']);
