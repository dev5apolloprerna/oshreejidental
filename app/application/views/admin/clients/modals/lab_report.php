            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="tw-flex">
                            ...
                            <div>
                                <h4 class="modal-title tw-mb-0">Upload</h4>
                            </div>
                        </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- <div id="contact-profile-image" class="form-group<?php if (isset($contact) && !empty($contact->profile_image)) {
                            echo ' hide';} ?>"> -->
                        <label for="profile_image"><small class="req text-danger">* </small>File</label>
                            <input type="file" name="file" class="form-control" id="file" accept=".doc, .docx, .pdf, .png, .jpg, .jpeg">
